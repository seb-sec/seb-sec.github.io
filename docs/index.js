...
function checkOffsets() {
  ...
  const cell = gridCellDimensions();
  const elements = document.querySelectorAll("body :not(.debug-grid, .theme-toggle)");
...
const getInitialState = () => {
  ...
  if(initialValue === null){
    let res = window.matchMedia('(prefers-color-scheme: dark)').matches;
...
function onThemeToggle() {
  document.body.classList.toggle("theme", themeToggle.checked);
  let theme = document.getElementById('theme');
