...
I decided to pick out a few of these challenges from the binary exploitation category, make writeups for them and cover some basic exploitation concepts from the point of few of a beginner with only a small amount of programming experience.
